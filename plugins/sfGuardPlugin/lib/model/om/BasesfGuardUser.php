...
abstract class BasesfGuardUser extends BaseObject  implements Persistent {
	...
	public function getsfGuardUserProfilesJoinAccount($criteria = null, $con = null)
	{
				include_once 'lib/model/om/BasesfGuardUserProfilePeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		...
		if ($this->collsfGuardUserProfiles === null) {
			if ($this->isNew()) {
				...
				$this->collsfGuardUserProfiles = sfGuardUserProfilePeer::doSelectJoinAccount($criteria, $con);
			}
		} else {
