...
abstract class BaseConfiguration extends BaseObject  implements Persistent {
	...
	public function setTitle($v)
	{
		...
		if ($this->title !== $v) {
			$this->title = $v;
			$this->modifiedColumns[] = ConfigurationPeer::TITLE;
		}
	...
	public function setConfigurationKey($v)
	{
		...
		if ($this->configuration_key !== $v) {
			...
			$this->modifiedColumns[] = ConfigurationPeer::CONFIGURATION_KEY;
		}
	...
	public function setConfigurationValue($v)
	{
		...
		if ($this->configuration_value !== $v) {
			...
			$this->modifiedColumns[] = ConfigurationPeer::CONFIGURATION_VALUE;
		}
    ...
    if ($this->isNew() && !$this->isColumnModified(ConfigurationPeer::CREATED_AT))
    {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ConfigurationPeer::TITLE)) $criteria->add(ConfigurationPeer::TITLE, $this->title);
		if ($this->isColumnModified(ConfigurationPeer::CONFIGURATION_KEY)) $criteria->add(ConfigurationPeer::CONFIGURATION_KEY, $this->configuration_key);
		if ($this->isColumnModified(ConfigurationPeer::CONFIGURATION_VALUE)) $criteria->add(ConfigurationPeer::CONFIGURATION_VALUE, $this->configuration_value);
