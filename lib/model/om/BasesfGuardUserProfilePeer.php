...
abstract class BasesfGuardUserProfilePeer {
	...
	const ACCOUNT_ID = 'sf_guard_user_profile.ACCOUNT_ID';
	...
	const FORCE_PASSWORD_CHANGE = 'sf_guard_user_profile.FORCE_PASSWORD_CHANGE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'AccountId', 'FirstName', 'LastName', 'UserId', 'IsDeleted', 'ForcePasswordChange', ),
		BasePeer::TYPE_COLNAME => array (sfGuardUserProfilePeer::ID, sfGuardUserProfilePeer::ACCOUNT_ID, sfGuardUserProfilePeer::FIRST_NAME, sfGuardUserProfilePeer::LAST_NAME, sfGuardUserProfilePeer::USER_ID, sfGuardUserProfilePeer::IS_DELETED, sfGuardUserProfilePeer::FORCE_PASSWORD_CHANGE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'account_id', 'first_name', 'last_name', 'user_id', 'is_deleted', 'force_password_change', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'AccountId' => 1, 'FirstName' => 2, 'LastName' => 3, 'UserId' => 4, 'IsDeleted' => 5, 'ForcePasswordChange' => 6, ),
		BasePeer::TYPE_COLNAME => array (sfGuardUserProfilePeer::ID => 0, sfGuardUserProfilePeer::ACCOUNT_ID => 1, sfGuardUserProfilePeer::FIRST_NAME => 2, sfGuardUserProfilePeer::LAST_NAME => 3, sfGuardUserProfilePeer::USER_ID => 4, sfGuardUserProfilePeer::IS_DELETED => 5, sfGuardUserProfilePeer::FORCE_PASSWORD_CHANGE => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'account_id' => 1, 'first_name' => 2, 'last_name' => 3, 'user_id' => 4, 'is_deleted' => 5, 'force_password_change' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(sfGuardUserProfilePeer::ACCOUNT_ID);
		...
		$criteria->addSelectColumn(sfGuardUserProfilePeer::FORCE_PASSWORD_CHANGE);
	...
	public static function doCountJoinAccount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(sfGuardUserProfilePeer::ACCOUNT_ID, AccountPeer::ID);
	...
	public static function doSelectJoinAccount(Criteria $c, $con = null)
	{
		...
		$c->addJoin(sfGuardUserProfilePeer::ACCOUNT_ID, AccountPeer::ID);
